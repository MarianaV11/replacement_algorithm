...
public class PageReplacementSimulator {
    ...
    // Método NRU
    public int nru() {
        // Inicializando o simulador de substituição de páginas com o algoritmo NRU
        NRUPageReplacement simulator = new NRUPageReplacement(frameSize);

        // Executando o algoritmo NRU e obtendo o número de faltas de página
        int pageFaults = simulator.nru(pageSequence);
        return pageFaults;
    }
